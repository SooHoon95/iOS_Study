...
//    print("2초 뒤 말했다! comment : \(comment)")
//})
//
//sayHiWithName(completion: { comment in
//    print("2초 뒤 말했다! comment : \(comment) 2")
//
//})
//
//sayHiWithName { comment in
//    print("2초 뒤 말했다! comment : \(comment) 3")
//}
//
//sayHiWithName {
//    print("2초 뒤 말했다! comment : \($0) ")
//}
//
